...
<div
    ...
    <div>
        <p><span
                style="color:red">Important</span>: Click in the fist cell (the passage) to read more context and get the full analysis of the passage.</p>
        <table
            id="resultsTable"
        ...
        >
            <thead>
                <tr><th
                    ...
                    <th
                        data-sortable="true">Ambiguous</th>
                    <th
